...
export default function FriendsScreen() {
  ...
  const [contacts, setContacts] = useState<ContactUser[]>([
    { id: '1', name: 'Arun Kumar', phone: '+91 98765 11111', isRegistered: true, isFriend: true, avatarColor: '#00A896' },
    { id: '2', name: 'Kavya Sharma', phone: '+91 98765 22222', isRegistered: true, isFriend: false, avatarColor: '#6366F1' },
    { id: '3', name: 'Praveen Raj', phone: '+91 98765 33333', isRegistered: true, isFriend: false, avatarColor: '#10B981' },
    { id: '4', name: 'Deepak Nathan', phone: '+91 98765 44444', isRegistered: false, isFriend: false, avatarColor: '#F59E0B' },
    { id: '5', name: 'Ananya Verma', phone: '+91 98765 55555', isRegistered: false, isFriend: false, avatarColor: '#EC4899' },
    { id: '6', name: 'Siddharth Roy', phone: '+91 98765 66666', isRegistered: false, isFriend: false, avatarColor: '#8B5CF6' },
  ]);
  ...
  const toggleFriendship = (id: string) => {
    setContacts((prev) =>
      prev.map((item) => (item.id === id ? { ...item, isFriend: !item.isFriend } : item))
    );
  };
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <View style={styles.headerTextWrapper}>
          ...
          <Text style={[styles.headerSubtitle, { color: colors.textSecondary }]}>Connect & invite trip companions</Text>
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.referralCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          ...
          <View style={styles.referralTextWrapper}>
            <Text style={[styles.referralTitle, { color: colors.text }]}>Invite Friends to SAFNORA</Text>
            <Text style={[styles.referralSubtitle, { color: colors.textSecondary }]}>
              Invite buddies using your code: <Text style={styles.codeHighlight}>{inviteCode}</Text>
            </Text>
          </View>
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <Feather name="share-2" size={16} color="#FFFFFF" style={{ marginRight: 4 }} />
        ...
        <View style={[styles.listCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          {registeredUsers.map((item, idx) => (
            <View
              ...
              style={[
                styles.contactRow,
                idx < registeredUsers.length - 1 && { borderBottomWidth: 1, borderBottomColor: colors.border },
              ]}
            >
              ...
              <TouchableOpacity
                style={[
                  styles.actionButton,
                  item.isFriend ? styles.friendAddedButton : styles.addFriendButton,
                ]}
              ...
              >
                <Feather
                  ...
                  style={{ marginRight: 4 }}
                />
                <Text style={item.isFriend ? styles.friendAddedText : styles.addFriendText}>
        ...
        <View style={[styles.listCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          {nonRegisteredUsers.map((item, idx) => (
            <View
              ...
              style={[
                styles.contactRow,
                idx < nonRegisteredUsers.length - 1 && { borderBottomWidth: 1, borderBottomColor: colors.border },
              ]}
            >
              <View style={[styles.avatarCircle, { backgroundColor: item.avatarColor }]}>
                <Text style={styles.avatarText}>{item.name[0]}</Text>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <Feather name="send" size={13} color="#00A896" style={{ marginRight: 4 }} />
...
const styles = StyleSheet.create({
  ...
  friendAddedButton: { backgroundColor: '#E1F8F2', borderWidth: 1, borderColor: '#10B981' },
