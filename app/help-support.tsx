  ...
  const faqs = [
    {
      ...
      answer:
        "Go to the Trips tab or click the + FAB button. Enter your Trip Name, Starting Point, Destination, and Dates to save the trip to your workspace.",
    },
    {
      id: "2",
      question: "How does SAFNORA calculate expense splits?",
      answer:
        "SAFNORA takes total expense amounts and automatically divides them equally by the number of active group members, showing exact cost per person.",
    },
    {
      id: "3",
      question: "Can I invite friends who don’t have SAFNORA?",
      answer:
        "Yes! Use the Share Invite Link button in the Friends & Contacts tab to send an SMS or WhatsApp invite link to any contact.",
    },
    {
      id: "4",
      question: "How do I change the cover photo of my trip?",
      answer:
        'Open your trip details dashboard and tap the "Change Cover" badge on the hero photo card to pick a new background picture.',
    },
  ];

  const handleEmailSupport = () => {
    Linking.openURL(
      "mailto:support@safnora.com?subject=SAFNORA%20Help%20Request",
    );
  };
      ...
      >
        ...
        <View style={styles.contactRowGrid}>
          ...
          >
            ...
            <Text style={[styles.contactTileTitle, { color: colors.text }]}>
              Email Support
            </Text>
            <Text
              style={[styles.contactTileSub, { color: colors.textSecondary }]}
            >
              support@safnora.com
            </Text>
          </TouchableOpacity>
        ...
        <View style={styles.versionFooter}>
          <Text style={[styles.versionText, { color: colors.textMuted }]}>
            SAFNORA App v2.4.0 (Latest Release)
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
