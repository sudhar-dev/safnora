    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.userCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          ...
          <TouchableOpacity
            style={[styles.editProfileButton, { backgroundColor: colors.surfaceSubtle, borderColor: colors.border }]}
          ...
          <View style={[styles.statsRow, { borderTopColor: colors.border }]}>
            <View style={styles.statItem}>
              ...
              <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Group Trips</Text>
            </View>
        ...
        <View style={[styles.brandCard, { backgroundColor: '#00A896' }]}>
          ...
          <Text style={styles.brandSummary}>
            Connecting people, places, plans, expenses, and memories into one digital journey.
          </Text>
        </View>
        ...
        <View style={[styles.menuCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          ...
          <TouchableOpacity style={[styles.menuRow, { borderBottomColor: colors.border }]} activeOpacity={0.7}>
            <View style={styles.menuLeft}>
              ...
              <Text style={[styles.menuText, { color: colors.text }]}>Privacy & Permissions</Text>
            </View>
            <Feather name="chevron-right" size={20} color={colors.textMuted} />
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  brandTagline: { color: '#E0F2FE', fontSize: 12, fontWeight: '600', marginTop: 1 },
