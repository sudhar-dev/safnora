        ...
        >
          <View style={styles.heroHeader}>
            ...
            <View style={styles.heroTextContainer}>
              ...
              <Text style={[styles.brandTagline, { color: colors.tint }]}>
                {SAFNORA_BRAND.tagline}
              </Text>
            </View>
          </View>
          <Text
          ...
          >
            Your all-in-one collaborative trip workspace. Plan itineraries,
            coordinate group expenses, share memories, and navigate together.
          </Text>
        </View>
