  ...
  const [posts, setPosts] = useState<SocialPost[]>([
    {
      ...
      caption:
        "Stunning waterfall view after a morning hike with the whole group! Rainbow visible near the lower falls. 🌊🌈 #TravelDiaries #WaterfallMagic",
      imageUri:
    ...
    },
    {
      ...
      caption:
        "Golden hour sunset over tea estate mountain curves. Unforgettable hill road drive with the crew! 🌄🚗 #ValparaiRoadtrip #TeaGardens",
      imageUri:
    ...
    },
    {
      ...
      caption:
        "360-degree hilltop mist and morning camp coffee! Best weekend getaway. ☕⛰️ #CoorgMist #CampVibes",
      imageUri:
          ...
          <View style={styles.createPostTopRow}>
            ...
            <TextInput
              style={[
                ...
                { color: colors.text, backgroundColor: colors.surfaceSubtle },
              ]}
          ...
          >
            ...
            >
              ...
              >
                ...
                <Text style={[styles.socialActionLabel, { color: "#6366F1" }]}>
                  Share
                </Text>
              </TouchableOpacity>
            </View>
