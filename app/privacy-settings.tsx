...
export default function PrivacySettingsScreen() {
  ...
  const handleExportData = () => {
    Alert.alert(
      "Data Exported",
      "A download link for your SAFNORA trip data has been sent to your email.",
    );
  };
        ...
        >
          <View style={styles.settingRow}>
            <View style={styles.textCol}>
              ...
              >
                Share real-time GPS location during active group trips
              </Text>
            </View>
            <Switch
          ...
          <View style={styles.settingRow}>
            <View style={styles.textCol}>
              ...
              <Text
                style={[styles.settingSub, { color: colors.textSecondary }]}
              >
                Allow friends to search you by phone number
              </Text>
            </View>
            <Switch
          ...
          <View style={styles.settingRow}>
            <View style={styles.textCol}>
              ...
              <Text
                style={[styles.settingSub, { color: colors.textSecondary }]}
              >
                Let trip companions see when you view itinerary updates
              </Text>
            </View>
            <Switch
              value={readReceipts}
          ...
          <View style={styles.settingRow}>
            <View style={styles.textCol}>
              ...
              <Text
                style={[styles.settingSub, { color: colors.textSecondary }]}
              >
                Sync address book to easily invite friends
              </Text>
            </View>
            <Switch
              value={contactsSync}
          ...
          <TouchableOpacity style={styles.actionRow} onPress={handleExportData}>
            <View style={styles.textCol}>
              ...
              <Text
                style={[styles.settingSub, { color: colors.textSecondary }]}
              >
                Export a JSON copy of all saved trips and expenses
              </Text>
            </View>
